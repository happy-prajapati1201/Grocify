...
// import { PiPlant ,PiFactory ,SlBadge} from 'react-icons/tb'
  ...
  return (   
    <section>
        <div className='max-w-[1400px] mx-auto px-10 py-20'>
            <div className='w-fit'>
                <Heading heighlight="our" Heading="Process"/>
            </div>

            <div className='flex flex-wrap gap-y-17 text-zinc-600 items-center justify-center md:mt-20 mt-10 md:pt-40' >
                {renderSteps}
            </div>
        </div>
    </section>
