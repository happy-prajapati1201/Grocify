      ...
      <div className='min-h-screen max-w-[1400px] mx-auto px-10 flex md:flex-row flex-col items-center md:pt-25 pt-35'>
        ...
        <div className='flex-1'>
            ...
            <p className='text-zinc-600 md:text-lg text-md max-w-[530px] mt-5 mb-10'>
                Bred for a high contect of beneficial substance. Our products are all fresh and healthy.
            </p>
            {/* <Button content='Shop Now'/> */}
            <Link to="/allproducts" className='bg-linear-to-b from-red-400 to-orange-500 text-white px-8 py-3 rounded-lg 
                        text-lg hover:scale-105 hover:to-orange-600 transition-all duration-300 cursor-pointer'>Shop Now</Link>
        </div>
        {/* Hero image */}
        <div className='flex-1'>
            <img src={Grocery} alt="Hero iamge" />
        </div>
      </div>
    </section>
  )
