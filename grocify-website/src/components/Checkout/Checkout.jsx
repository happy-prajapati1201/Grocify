...
const Checkout = () => {
  ...
  const handlePay = (e) => {
    ...
    // Navigate to bill page with order data
    navigate('/bill', {
      state: {
        orderId,
        address,
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8'>
          <div className='lg:col-span-2 space-y-6'>
            ...
            <form onSubmit={handlePay} className='bg-zinc-100 rounded-xl p-6 space-y-5'>
              ...
              <button 
                type='submit' 
                className='w-full bg-linear-to-b from-red-400 to-orange-500 text-white px-6 py-3 rounded-lg text-lg hover:scale-[1.01] hover:to-orange-600 transition-all duration-300'>
                Confirm Order
              </button>
            </form>
          </div>
